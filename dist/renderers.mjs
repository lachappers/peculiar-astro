...
import { AstroJSX, AstroError, renderJSX, createVNode } from './chunks/1707728410672/astro.mjs';
import 'kleur/colors';
import 'clsx';
import 'cssesc';
import 'html-escaper';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && opts.experimentalReactChildren) {
		...
		const convert = await import('./chunks/1707728410672/vnode-children.mjs').then((mod) => mod.default);
