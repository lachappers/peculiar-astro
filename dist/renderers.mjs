...
import { AstroJSX, AstroError, renderJSX, createVNode } from './chunks/1707993832679/astro.mjs';
import 'kleur/colors';
import 'clsx';
import 'cssesc';
import 'html-escaper';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && opts.experimentalReactChildren) {
		...
		const convert = await import('./chunks/1707993832679/vnode-children.mjs').then((mod) => mod.default);
