    ...
    languages: {
      en: {
        consent_modal: {
          ...
          description:
            'Hi, this website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it. The latter will be set only after consent.<br/> <button type="button" data-cc="c-settings" class="cc-link">Let me choose.</button>',
          primary_btn: {
            text: "Accept all",
          ...
          revision_message:
            "<br><br> Our terms and conditions have changed since the last time you visisted!",
        },
        settings_modal: {
